-- Add validation_timing to supported adaptation types
...
CHECK (adaptation_type IN (
    ...
    'validation_timing', 'visual_emphasis'
));

-- Add comment for new adaptation type
COMMENT ON CONSTRAINT adaptations_adaptation_type_check ON public.adaptations 
IS 'Valid adaptation types including validation_timing for real-time form validation optimization';